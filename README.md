...
Scaffolding tool for Vue single page application, as inspired by generator-yolo's folder structure. Generator-Velo has been built on top of project setup from Vue-CLI.
...
2.  **Install Yeoman**
 This is a generator dependency, thus there is no need for you to study Yeoman documentation. "-g" flag installs this dependency globally. Enter this in terminal to install Yeoman:
...
|__ .browserslistrc		# Supported browsers config (affect babel and css autoprefix)
|__ .editorconfig
